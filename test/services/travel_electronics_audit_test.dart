...
void main() {
  ...
  test('travel and electronics audit report', () {
    final sentences = File('test/fixtures/travel_electronics_sentences.txt')
        .readAsLinesSync()
        .where((l) => l.trim().isNotEmpty)
        .toList();
    expect(sentences.length, greaterThan(130));
    ...
    // ignore: avoid_print
    print('=== TRAVEL/ELECTRONICS AUDIT ($n sentences) ===');
    // ignore: avoid_print
