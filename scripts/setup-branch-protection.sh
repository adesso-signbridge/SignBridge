#!/usr/bin/env bash
# Enable merge blocking on main: PRs must pass the "PR merge gate" check (7 core CI jobs).
#
# Prerequisites:
...
echo "Required status check: PR merge gate (7 core CI jobs)"
echo ""
...
echo "  1. All 7 core CI jobs pass, and"
